...
hidden_dim = 25 #it's a number of parameters we want to estimate, e.g. # conv1 filters
...
class Lenet(nn.Module):
    def __init__(self, nodesNum1, nodesNum2, nodesFc1, nodesFc2):
        ...
        self.parameter = Parameter(-1*torch.ones(nodesNum2),requires_grad=True) # this parameter lies #S
        #-2e10, 1, 5, -2
