...
#actually the original archicture was 6,16,120,84
    ...
    if network=='lenet5':
        ...
        if dataset=='cifar':
            input_shape=(1,32,32)
            layers_type = ['C', 'C', 'P', 'C', 'C', 'P', 'C', 'C', 'C', 'P', 'C', 'C', 'C', 'P', 'C', 'C', 'C', 'P', 'FC',
                      'FC']
        ...
        if dataset=='cifar':
            conv_filters=[[3,filter_nums[0],3,3],  [filter_nums[0],filter_nums[1],3,3], [2,2],
              ...
              [filter_nums[3],filter_nums[4],3,3], [filter_nums[4],filter_nums[5],3,3],  [filter_nums[5],filter_nums[6],3,3], [2,2],
              [filter_nums[6],filter_nums[7],3,3], [filter_nums[7],filter_nums[8],3,3],  [filter_nums[8],filter_nums[9],3,3], [2,2],
              [filter_nums[9],filter_nums[10],3,3],[filter_nums[10],filter_nums[11],3,3],  [filter_nums[11],filter_nums[12],3,3], [2,2],
    ...
    for i in range(1, len(layers_type)+1): #i is the number of the layer
        ...
        if layer_type=='C':
            ...
            if len(input_shape)==3:
                total_flops_per_layer=input_shape[0]*num_instances_per_filter_rows*num_instances_per_filter_cols*conv_filter[0]
            else:
            ...
            ############################
            if len(input_shape) == 3:
                params = input_shape[0]*num_instances_per_filter_rows*num_instances_per_filter_cols*conv_filter[0]+conv_filter[0]
            else:
